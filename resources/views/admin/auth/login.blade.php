        ...
        <div class="authentication-inner row m-0">
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
                <div class="w-100 d-flex justify-content-center">
                    <img src="{{ asset('assets/admin/img/illustrations/boy-with-rocket-light.png') }}" class="img-fluid"
                ...
                <div class="w-px-400 mx-auto">
                    <div class="app-brand mb-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Core</span>
                        </a>
                    </div>
                    <h4 class="mb-2">Welcome to Core! 👋</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('admin.login.post') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="admin"
                                autofocus value="{{ old('username') ?? 'admin' }}">
                        </div>
